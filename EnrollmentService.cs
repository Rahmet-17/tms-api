...
public class EnrollmentService : IEnrollmentService
{
    ...
    // ✅ FIX 1: Add duplicate check + LogWarning
    ...
    // ✅ FIX 2: LogWarning when not found
    ...
    // ✅ FIX 3: LogInformation + LogWarning
...
public class EnrollmentWorker
{
    ...
    public void ProcessBatch()
    {
        ...
        var record = service
            .EnrollAsync("S-002", "CS-102")
            .GetAwaiter()
            .GetResult();

        Console.WriteLine($"Worker enrolled: {record}");
